...
FROM [SalesSuperStore].[dbo].[SellesSuperStore];
...
UPDATE [SalesSuperStore].[dbo].[SellesSuperStore]
SET
...
WHERE TABLE_NAME = 'SellesSuperStore'
...
WHERE tc.CONSTRAINT_TYPE = 'PRIMARY KEY'
  AND ku.TABLE_NAME = 'SellesSuperStore'
...
ALTER TABLE [SalesSuperStore].[dbo].[SellesSuperStore]
ADD CONSTRAINT PK_SellesSuperStore_ROW_ID PRIMARY KEY ([ROW_ID]);



-- Verify Data Consistency

SELECT  * FROM [SalesSuperStore].[dbo].[SellesSuperStore];
